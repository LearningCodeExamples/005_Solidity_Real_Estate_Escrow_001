...
describe('RealEstate', () => {
  ...
  let nftId = 1
  let purchasePrice = ether(1000)
  let escrowAmount = ether(200)
  ...
  describe('Selling real estate', () => {
    ...
    it('executes a successful transaction', async () => {
      ...
      // Lender funds sale
      transaction = await lender.sendTransaction({ to: escrow.address, value: ether(800) })
      ...
      expect(balance).to.be.above(ether(10999))
    })
